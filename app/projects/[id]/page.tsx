    ...
    return (
      <div className="min-h-screen bg-neutral-950 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-4">Project niet gevonden</h1>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="relative aspect-video bg-gradient-to-br from-neutral-900 via-emerald-950/10 to-neutral-900 border border-emerald-800/30 rounded-xl overflow-hidden mb-4 flex items-center justify-center p-2 group">
              {project.images.length > 0 ? (
                <img
                  ...
                  alt={`${project.title} schermafbeelding ${selectedImage + 1}`}
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              <h2 className="text-2xl font-bold text-white mb-6">Over dit project</h2>
            ...
            <div className="space-y-8">
              {/* Features */}
              <div>
                <h3 className="text-xl font-bold text-white mb-4">Functies</h3>
              ...
              {/* Links */}
              <div>
                <h3 className="text-xl font-bold text-white mb-4">Koppelingen</h3>
